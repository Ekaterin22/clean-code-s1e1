...
var createNewTaskElement=function(taskString){
    ...
    editInput.classList.add('input', 'input-text');
...
var addTask=function(){
    ...
    listItem.classList.add('incomplete-li');
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("mode-edit");
    //If class of the parent is .mode-edit
    if(containsClass){
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    listItem.classList.remove('incomplete-li');
    listItem.classList.add('completed-li');
...
//Mark task as incomplete.
    ...
    var listItem=this.parentNode;
    listItem.classList.remove('completed-li');
    listItem.classList.add('incomplete-li');
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
